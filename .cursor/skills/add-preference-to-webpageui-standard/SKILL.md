---
name: add-preference-to-webpageui-standard
description: >-
...
- Preference files: `.cursor/skills/add-preference-to-webpageui-standard/preferences/<slug>.md` (one file per preference)
...
1. Ensure `.cursor/skills/add-preference-to-webpageui-standard/preferences/` exists
2. Create `.cursor/skills/add-preference-to-webpageui-standard/preferences/<slug>.md` using this template:
...
|-------|----------|----------|------|
| `<preference_title>` | `<category>` | `<standard>` | [../add-preference-to-webpageui-standard/preferences/`<slug>`.md](../add-preference-to-webpageui-standard/preferences/`<slug>`.md) |
...
- File: .cursor/skills/add-preference-to-webpageui-standard/preferences/<slug>.md
...
| Item | Value |
|------|-------|
| Skill path | `.cursor/skills/add-preference-to-webpageui-standard/SKILL.md` |
| Lookup table | `.cursor/skills/webpage-debugging/webpageui-standard.md` |
| Lookup section | `## User preferences` |
| Preferences dir | `.cursor/skills/add-preference-to-webpageui-standard/preferences/` |
| Preference file | `.cursor/skills/add-preference-to-webpageui-standard/preferences/<slug>.md` |
...
- "add-preference-to-webpageui-standard"
